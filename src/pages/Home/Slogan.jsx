    ...
    <div className="container h-full flex flex-wrap">
         <div className="sm:w-9/12 w-full h-full flex justify-center flex-col" id='slogan'>
              <h3 className='text-white text-2xl text-center font-bold sm:text-left sm:text-4xl'>We are helping people from 10 years</h3>
                <p className="text-md mt-2 text-white sm:mt-4 text-center sm:text-left">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat aspernatur modi quisquam exercitationem aut, vel minima iusto repudiandae! Distinctio facere iure consequatur, labore ex beatae. Repellat culpa minus laborum exercitationem!</p>
         </div>
