...
import { fetchMyInfo } from './UserManager/userSlice';
...
const Profile = () => {
  ...
  return (
    <DefaultLayout>
     ...
     {
      loading!=true?( <div className='overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
      ...
      <div className='px-4 pb-6 text-center lg:pb-8 xl:pb-11.5'>
        <div className='relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3'>
          <div className='relative drop-shadow-2'>
            <img src={BASE_URL+data.userInfo?.avatar} className='w-[200px] h-[150px] object-cover rounded-full' alt='profile' />
            <label
              htmlFor='profile'
      ...
      <div className="h-[100vh] w-full flex justify-center items-center">
        <ReactLoading height={80} width={80} type='spin' />
      </div>
    </>
     }
    </DefaultLayout>
